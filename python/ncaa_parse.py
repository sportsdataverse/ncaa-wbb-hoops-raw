"""Bundle -> pbp / shots / lineups frames.

League binding for :mod:`sportsdataverse.scrape.ncaa.parse` (sdv-py #328).
...
from sportsdataverse.scrape.ncaa import parse as _engine
