"""Id enrichment for parsed frames.

League binding for :mod:`sportsdataverse.scrape.ncaa.identity` (sdv-py #328).
...
from sportsdataverse.scrape.ncaa import identity as _engine
