"""Contest-id discovery -> schedule_master.

League binding for :mod:`sportsdataverse.scrape.ncaa.discover` (sdv-py #328).
...
from sportsdataverse.scrape.ncaa import discover as _engine
