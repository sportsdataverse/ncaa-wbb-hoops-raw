"""Per-contest 3-page bundle capture.

League binding for :mod:`sportsdataverse.scrape.ncaa.capture` (sdv-py #328).
...
from sportsdataverse.scrape.ncaa import capture as _engine
