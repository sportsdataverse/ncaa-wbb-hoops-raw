"""Pre-flight transport probe.

League binding for :mod:`sportsdataverse.scrape.ncaa.canary` (sdv-py #328).
...
from sportsdataverse.scrape.ncaa import canary as _engine
